...
echo /usr/bin/xsltproc $report_dir/$name_of_host.xml > $report_dir/sorted_$name_of_host.xml
echo /usr/bin/xsltproc $report_dir/sorted_$name_of_host.xml > $report_dir/$name_of_host.html
