...
echo /usr/bin/xsltproc $xsl_dir/sort_output.xsl $report_dir/$name_of_host.xml -o $report_dir/sorted_$name_of_host.xml
echo /usr/bin/xsltproc $report_xsl $report_dir/sorted_$name_of_host.xml -o $report_dir/index.html
